...
def run():
    ...
    # anova_black_pastel_style(people_csv_file_path).make_output()
    # anova_red_spirals_style(people_csv_file_path).make_output()
    # chi_square(people_csv_file_path).make_output()
    # independent_t_test(people_csv_file_path).make_output()
    # kruskal_wallis_h(people_csv_file_path).make_output()
    # mann_whitney_u(people_csv_file_path).make_output()
    # normality(people_csv_file_path).make_output()
    # paired_t_test(people_csv_file_path).make_output()
    # pearsons_r(people_csv_file_path).make_output()
    # spearmans_r(people_csv_file_path).make_output()
    # wilcoxon_signed_ranks(people_csv_file_path).make_output()
